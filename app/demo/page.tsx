    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border bg-white py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <Link href="/">
            <Button variant="link" className="mt-4 px-0 text-[#003A70]">
              ← Back to Home
            </Button>
          </Link>
        </div>
      ...
      <section className="py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 space-y-12">
                ...
                <div>
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      "View provenance (Expand → Provenance)",
                    ].map((item, i) => (
                      <li key={i} className="flex items-start gap-4">
                        <CheckCircle2 className="h-6 w-6 flex-shrink-0 text-green-600" />
                        <span className="text-lg text-foreground">{item}</span>
            ...
            <CardContent className="p-8">
              <div className="space-y-6">
                ...
                <Button
                  ...
                  className="h-12 w-full bg-[#003A70] text-base font-semibold hover:bg-[#0052A3] disabled:bg-muted"
                >
                  Create Deliverable
                </Button>
              </div>
          ...
          <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 via-blue-50 to-green-50">
            <CardContent className="p-12">
              <h3 className="mb-10 text-4xl font-bold text-foreground">🔍 How to See Voice Transformations</h3>

              {/* Quick Start Guide */}
              <Card className="mb-8 border-2 border-blue-300 bg-white">
                <CardContent className="p-8">
                  ...
                  <ol className="space-y-4">
                    {[
                      ...
                      "Click "Expand" on both cards to compare content",
                    ].map((step, i) => (
                      <li key={i} className="flex items-start gap-4">
